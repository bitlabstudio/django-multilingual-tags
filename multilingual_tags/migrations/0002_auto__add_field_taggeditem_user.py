...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        # Deleting field 'TaggedItem.user'
        db.delete_column(u'multilingual_tags_taggeditem', 'user_id')
    ...
    models = {
        ...
        u'multilingual_tags.taggeditem': {
            ...
            'content_type': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'tagged_items'", 'to': u"orm['contenttypes.ContentType']"}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
